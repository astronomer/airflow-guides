...
For Astronomer customers using [Astro](https://www.astronomer.io/product/), lineage is fully inegrated with the product and available out of the box. Astro leverages OpenLineage to collect lineage data, and the **Lineage** tab in the Astronomer UI provides the lineage front end. For more on the lineage capabilities of Astro, check out our documentation or [reach out to us](https://www.astronomer.io/openlineage). 
