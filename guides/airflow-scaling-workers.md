...
On Astronomer, simply increase the slider on the workers to give them more resources![image](https://assets2.astronomer.io/main/guides/airflow-scaling-workers/worker_slider.png)
