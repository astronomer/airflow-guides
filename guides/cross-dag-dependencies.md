...
The graph view of this DAG looks like this, where the `trigger_dependent_dag` task in the middle is the `TriggerDagRunOperator` which runs the `dependent-dag`. 
